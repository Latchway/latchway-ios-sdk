...
Do not include live identity tokens, refresh tokens, DPoP proofs, App Attest
...
Treat changes to Secure Enclave and Keychain access controls, P-256 signing,
JWK thumbprints, DPoP proof construction, App Attest lifecycle, session refresh,
