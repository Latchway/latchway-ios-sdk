...
| [MacPaw/OpenAI 0.5.1](macpaw-openai-0.5.1.md) | Do not ship or advertise a stock-0.5.1 adapter; an upstream-ready async-interception patch passes all 217 tests in the patched official source but is not merged or released. |
